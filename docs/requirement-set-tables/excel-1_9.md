...
||[iterativeCalculation](/javascript/api/excel/excel.application#iterativecalculation)|Devuelve la configuración del cálculo iterativo.|
...
||[getRange()](/javascript/api/excel/excel.autofilter#getrange--)|Devuelve el objeto que representa el intervalo al que se aplica `Range` el Autofiltro.|
||[getRangeOrNullObject()](/javascript/api/excel/excel.autofilter#getrangeornullobject--)|Devuelve el objeto que representa el intervalo al que se aplica `Range` el Autofiltro.|
...
|[ChangedEventDetail](/javascript/api/excel/excel.changedeventdetail)|[valueAfter](/javascript/api/excel/excel.changedeventdetail#valueafter)|Representa el valor después del cambio.|
||[valueBefore](/javascript/api/excel/excel.changedeventdetail#valuebefore)|Representa el valor antes del cambio.|
||[valueTypeAfter](/javascript/api/excel/excel.changedeventdetail#valuetypeafter)|Representa el tipo de valor después del cambio.|
||[valueTypeBefore](/javascript/api/excel/excel.changedeventdetail#valuetypebefore)|Representa el tipo de valor antes del cambio.|
...
||[gradientMinimumColor](/javascript/api/excel/excel.chartseries#gradientminimumcolor)|Especifica el color del valor mínimo de una serie de gráficos de mapa de región.|
...
|[ConditionalFormat](/javascript/api/excel/excel.conditionalformat)|[getRanges()](/javascript/api/excel/excel.conditionalformat#getranges--)|Devuelve el , que comprende uno o más intervalos rectangulares, al que se aplica el `RangeAreas` formato conditonal.|
|[DataValidation](/javascript/api/excel/excel.datavalidation)|[getInvalidCells()](/javascript/api/excel/excel.datavalidation#getinvalidcells--)|Devuelve un `RangeAreas` objeto, que consta de uno o más intervalos rectangulares, con valores de celda no válidos.|
||[getInvalidCellsOrNullObject()](/javascript/api/excel/excel.datavalidation#getinvalidcellsornullobject--)|Devuelve un `RangeAreas` objeto, que consta de uno o más intervalos rectangulares, con valores de celda no válidos.|
|[FilterCriteria](/javascript/api/excel/excel.filtercriteria)|[subField](/javascript/api/excel/excel.filtercriteria#subfield)|La propiedad usada por el filtro para realizar un filtro enriquecido en valores enriquecidos.|
...
||[shape](/javascript/api/excel/excel.geometricshape#shape)|Devuelve el `Shape` objeto de la forma geométrica.|
...
||[getItem(key: string)](/javascript/api/excel/excel.groupshapecollection#getitem-key-)|Obtiene una forma con su nombre o identificador.|
...
||[shape](/javascript/api/excel/excel.line#shape)|Devuelve el `Shape` objeto asociado a la línea.|
...
||[getPrintArea()](/javascript/api/excel/excel.pagelayout#getprintarea--)|Obtiene el `RangeAreas` objeto, que comprende uno o más intervalos rectangulares, que representa el área de impresión de la hoja de cálculo.|
||[getPrintAreaOrNullObject()](/javascript/api/excel/excel.pagelayout#getprintareaornullobject--)|Obtiene el `RangeAreas` objeto, que comprende uno o más intervalos rectangulares, que representa el área de impresión de la hoja de cálculo.|
...
||[flashFill()](/javascript/api/excel/excel.range#flashfill--)|Realiza un relleno de flash en el intervalo actual.|
...
||[getSpecialCells(cellType: Excel.SpecialCellType, cellValueType?: Excel.SpecialCellValueType)](/javascript/api/excel/excel.range#getspecialcells-celltype--cellvaluetype-)|Obtiene el objeto, que comprende uno o varios intervalos rectangulares, que representa todas las celdas que `RangeAreas` coinciden con el tipo y el valor especificados.|
||[getSpecialCellsOrNullObject(cellType: Excel.SpecialCellType, cellValueType?: Excel.SpecialCellValueType)](/javascript/api/excel/excel.range#getspecialcellsornullobject-celltype--cellvaluetype-)|Obtiene el objeto, que comprende uno o varios intervalos, que representa todas las celdas que `RangeAreas` coinciden con el tipo y el valor especificados.|
...
||[setCellProperties(cellPropertiesData: SettableCellProperties[][])](/javascript/api/excel/excel.range#setcellproperties-cellpropertiesdata-)|Actualiza el rango en función de una matriz 2D de propiedades de celda, encapsulando elementos como fuente, relleno, bordes y alineación.|
||[setColumnProperties(columnPropertiesData: SettableColumnProperties[])](/javascript/api/excel/excel.range#setcolumnproperties-columnpropertiesdata-)|Actualiza el rango en función de una matriz unidimensional de propiedades de columna, encapsulando elementos como fuente, relleno, bordes y alineación.|
...
||[setRowProperties(rowPropertiesData: SettableRowProperties[])](/javascript/api/excel/excel.range#setrowproperties-rowpropertiesdata-)|Actualiza el rango en función de una matriz unidimensional de propiedades de fila, encapsulando elementos como fuente, relleno, bordes y alineación.|
|[RangeAreas](/javascript/api/excel/excel.rangeareas)|[calculate()](/javascript/api/excel/excel.rangeareas#calculate--)|Calcula todas las celdas del `RangeAreas` .|
||[clear(applyTo?: Excel.ClearApplyTo)](/javascript/api/excel/excel.rangeareas#clear-applyto-)|Borra valores, formato, relleno, borde y otras propiedades en cada una de las áreas que componen este `RangeAreas` objeto.|
||[convertDataTypeToText()](/javascript/api/excel/excel.rangeareas#convertdatatypetotext--)|Convierte todas las celdas de los `RangeAreas` tipos de datos with en texto.|
||[convertToLinkedDataType(serviceID: number, languageCulture: string)](/javascript/api/excel/excel.rangeareas#converttolinkeddatatype-serviceid--languageculture-)|Convierte todas las celdas en `RangeAreas` tipos de datos vinculados.|
||[copyFrom(sourceRange: Range \| RangeAreas \| string, copyType?: Excel.RangeCopyType, skipBlanks?: boolean, transpose?: boolean)](/javascript/api/excel/excel.rangeareas#copyfrom-sourcerange--copytype--skipblanks--transpose-)|Copia los datos de celda o el formato del intervalo de origen o `RangeAreas` al actual `RangeAreas` .|
||[getEntireColumn()](/javascript/api/excel/excel.rangeareas#getentirecolumn--)|Devuelve un objeto que representa todas las columnas de la (por ejemplo, si la corriente representa las celdas `RangeAreas` `RangeAreas` `RangeAreas` "B4:E11, H2", devuelve una que representa las columnas `RangeAreas` "B:E, H:H").|
||[getEntireRow()](/javascript/api/excel/excel.rangeareas#getentirerow--)|Devuelve un objeto que representa todas las filas de la (por ejemplo, si la corriente representa las celdas "B4:E11", devuelve un que representa las filas `RangeAreas` `RangeAreas` `RangeAreas` `RangeAreas` "4:11").|
||[getIntersection(anotherRange: Range \| RangeAreas \| string)](/javascript/api/excel/excel.rangeareas#getintersection-anotherrange-)|Devuelve el `RangeAreas` objeto que representa la intersección de los intervalos especificados o `RangeAreas` .|
||[getIntersectionOrNullObject(anotherRange: Range \| RangeAreas \| string)](/javascript/api/excel/excel.rangeareas#getintersectionornullobject-anotherrange-)|Devuelve el `RangeAreas` objeto que representa la intersección de los intervalos especificados o `RangeAreas` .|
||[getOffsetRangeAreas(rowOffset: number, columnOffset: number)](/javascript/api/excel/excel.rangeareas#getoffsetrangeareas-rowoffset--columnoffset-)|Devuelve un `RangeAreas` objeto que se desplaza por el desplazamiento específico de fila y columna.|
||[getSpecialCells(cellType: Excel.SpecialCellType, cellValueType?: Excel.SpecialCellValueType)](/javascript/api/excel/excel.rangeareas#getspecialcells-celltype--cellvaluetype-)|Devuelve un `RangeAreas` objeto que representa todas las celdas que coinciden con el tipo y el valor especificados.|
||[getSpecialCellsOrNullObject(cellType: Excel.SpecialCellType, cellValueType?: Excel.SpecialCellValueType)](/javascript/api/excel/excel.rangeareas#getspecialcellsornullobject-celltype--cellvaluetype-)|Devuelve un `RangeAreas` objeto que representa todas las celdas que coinciden con el tipo y el valor especificados.|
||[getTables(fullyContained?: boolean)](/javascript/api/excel/excel.rangeareas#gettables-fullycontained-)|Devuelve una colección de tablas con ámbito que se superponen con cualquier intervalo de este `RangeAreas` objeto.|
||[getUsedRangeAreas(valuesOnly?: boolean)](/javascript/api/excel/excel.rangeareas#getusedrangeareas-valuesonly-)|Devuelve el usado `RangeAreas` que comprende todas las áreas usadas de intervalos rectangulares individuales del `RangeAreas` objeto.|
||[getUsedRangeAreasOrNullObject(valuesOnly?: boolean)](/javascript/api/excel/excel.rangeareas#getusedrangeareasornullobject-valuesonly-)|Devuelve el usado `RangeAreas` que comprende todas las áreas usadas de intervalos rectangulares individuales del `RangeAreas` objeto.|
||[address](/javascript/api/excel/excel.rangeareas#address)|Devuelve la `RangeAreas` referencia en estilo A1.|
||[addressLocal](/javascript/api/excel/excel.rangeareas#addresslocal)|Devuelve la `RangeAreas` referencia en la configuración regional del usuario.|
||[areaCount](/javascript/api/excel/excel.rangeareas#areacount)|Devuelve el número de intervalos rectangulares que componen este `RangeAreas` objeto.|
||[areas](/javascript/api/excel/excel.rangeareas#areas)|Devuelve una colección de intervalos rectangulares que componen este `RangeAreas` objeto.|
||[cellCount](/javascript/api/excel/excel.rangeareas#cellcount)|Devuelve el número de celdas del objeto, sumando los recuentos de celdas de `RangeAreas` todos los intervalos rectangulares individuales.|
||[conditionalFormats](/javascript/api/excel/excel.rangeareas#conditionalformats)|Devuelve una colección de formatos condicionales que se cruzan con las celdas de este `RangeAreas` objeto.|
||[dataValidation](/javascript/api/excel/excel.rangeareas#datavalidation)|Devuelve un objeto de validación de datos para todos los intervalos de `RangeAreas` .|
||[format](/javascript/api/excel/excel.rangeareas#format)|Devuelve un `RangeFormat` objeto, encapsulando la fuente, el relleno, los bordes, la alineación y otras propiedades de todos los rangos del `RangeAreas` objeto.|
||[isEntireColumn](/javascript/api/excel/excel.rangeareas#isentirecolumn)|Especifica si todos los intervalos de este objeto representan columnas enteras `RangeAreas` (por ejemplo, "A:C, Q:Z").|
||[isEntireRow](/javascript/api/excel/excel.rangeareas#isentirerow)|Especifica si todos los intervalos de este objeto representan filas completas `RangeAreas` (por ejemplo, "1:3, 5:7").|
||[worksheet](/javascript/api/excel/excel.rangeareas#worksheet)|Devuelve la hoja de cálculo de `RangeAreas` la actual .|
||[setDirty()](/javascript/api/excel/excel.rangeareas#setdirty--)|Establece el `RangeAreas` que se va a volver a calcular cuando se produzca la siguiente actualización.|
||[estilo](/javascript/api/excel/excel.rangeareas#style)|Representa el estilo de todos los rangos de este `RangeAreas` objeto.|
|[RangeBorder](/javascript/api/excel/excel.rangeborder)|[tintAndShade](/javascript/api/excel/excel.rangeborder#tintandshade)|Especifica un doble que aligera u oscurece un color para el borde del intervalo, el valor está entre -1 (más oscuro) y 1 (más brillante), con 0 para el color original.|
|[RangeBorderCollection](/javascript/api/excel/excel.rangebordercollection)|[tintAndShade](/javascript/api/excel/excel.rangebordercollection#tintandshade)|Especifica un doble que aligera u oscurece un color para los bordes del intervalo.|
...
||[getItemAt(index: number)](/javascript/api/excel/excel.rangecollection#getitemat-index-)|Devuelve el objeto range en función de su posición en `RangeCollection` el .|
...
||[patternColor](/javascript/api/excel/excel.rangefill#patterncolor)|El código de color HTML que representa el color del patrón de intervalo, con el formato #RRGGBB (por ejemplo, "FFA500") o como un color HTML con nombre (por ejemplo, "naranja").|
||[patternTintAndShade](/javascript/api/excel/excel.rangefill#patterntintandshade)|Especifica un doble que aligera u oscurece un color de patrón para el relleno del intervalo.|
||[tintAndShade](/javascript/api/excel/excel.rangefill#tintandshade)|Especifica un doble que aligera u oscurece un color para el relleno del intervalo.|
...
||[subscript](/javascript/api/excel/excel.rangefont#subscript)|Especifica el estado de subíndice de fuente.|
||[superscript](/javascript/api/excel/excel.rangefont#superscript)|Especifica el estado de superíndice de la fuente.|
||[tintAndShade](/javascript/api/excel/excel.rangefont#tintandshade)|Especifica un doble que aligera u oscurece un color para la fuente del rango.|
...
||[altTextTitle](/javascript/api/excel/excel.shape#alttexttitle)|Especifica el texto de título alternativo para un `Shape` objeto.|
...
||[getItem(key: string)](/javascript/api/excel/excel.shapecollection#getitem-key-)|Obtiene una forma con su nombre o identificador.|
...
||[foregroundColor](/javascript/api/excel/excel.shapefill#foregroundcolor)|Representa el color de primer plano de relleno de forma en formato de color HTML, con el formato #RRGGBB (por ejemplo, "FFA500") o como un color HTML con nombre (por ejemplo, "naranja")|
...
||[shape](/javascript/api/excel/excel.shapegroup#shape)|Devuelve el `Shape` objeto asociado al grupo.|
||[shapes](/javascript/api/excel/excel.shapegroup#shapes)|Devuelve la colección de `Shape` objetos.|
...
|[Table](/javascript/api/excel/excel.table)|[autoFilter](/javascript/api/excel/excel.table#autofilter)|Representa el `AutoFilter` objeto de la tabla.|
...
||[worksheetId](/javascript/api/excel/excel.tableaddedeventargs#worksheetid)|Obtiene el identificador de la hoja de cálculo en la que se agrega la tabla.|
...
||[getItem(key: string)](/javascript/api/excel/excel.tablescopedcollection#getitem-key-)|Obtener una tabla por nombre o identificador.|
...
||[font](/javascript/api/excel/excel.textrange#font)|Devuelve un `ShapeFont` objeto que representa los atributos de fuente del intervalo de texto.|
...
||[getIsActiveCollabSession()](/javascript/api/excel/excel.workbook#getisactivecollabsession--)|Devuelve si varios usuarios están editando el libro (a través `true` de la co-autoría).|
...
||[autoSave](/javascript/api/excel/excel.workbook#autosave)|Especifica si el libro está en modo autoguardado.|
...
||[onAutoSaveSettingChanged](/javascript/api/excel/excel.workbook#onautosavesettingchanged)|Se produce cuando se cambia la configuración de Autoguardado en el libro.|
...
||[findAll(text: string, criteria: Excel.WorksheetSearchCriteria)](/javascript/api/excel/excel.worksheet#findall-text--criteria-)|Busca todas las repeticiones de la cadena determinada en función de los criterios especificados y las devuelve como un objeto, que comprende `RangeAreas` uno o más intervalos rectangulares.|
...
||[getRanges(address?: string)](/javascript/api/excel/excel.worksheet#getranges-address-)|Obtiene el `RangeAreas` objeto, que representa uno o varios bloques de intervalos rectangulares, especificados por la dirección o el nombre.|
||[autoFilter](/javascript/api/excel/excel.worksheet#autofilter)|Representa el `AutoFilter` objeto de la hoja de cálculo.|
...
||[pageLayout](/javascript/api/excel/excel.worksheet#pagelayout)|Obtiene el `PageLayout` objeto de la hoja de cálculo.|
...
||[onFormatChanged](/javascript/api/excel/excel.worksheetcollection#onformatchanged)|Se produce cuando cualquier hoja de cálculo del libro tiene un formato cambiado.|
...
||[worksheetId](/javascript/api/excel/excel.worksheetformatchangedeventargs#worksheetid)|Obtiene el identificador de la hoja de cálculo en la que cambiaron los datos.|
