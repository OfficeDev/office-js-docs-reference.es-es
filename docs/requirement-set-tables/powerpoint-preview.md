...
|[Shape](/javascript/api/powerpoint/powerpoint.shape)|[delete()](/javascript/api/powerpoint/powerpoint.shape#delete--)|Elimina la forma de la colección de formas.|
||[id](/javascript/api/powerpoint/powerpoint.shape#id)|Obtiene el identificador único de la forma.|
...
|[Colección de etiquetas](/javascript/api/powerpoint/powerpoint.tagcollection)|[add(key: string, value: string)](/javascript/api/powerpoint/powerpoint.tagcollection#add-key--value-)|Agrega una nueva etiqueta al final de la colección.|
