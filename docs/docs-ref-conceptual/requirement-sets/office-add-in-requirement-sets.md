...
| DialogApi | Vea [conjuntos de API de cuadro de diálogo requisitos](dialog-api-requirement-sets.md). | UI.messageParent<br>UI.displayDialogAsync<br>UI.closeContainer<br>UI.Dialog |
