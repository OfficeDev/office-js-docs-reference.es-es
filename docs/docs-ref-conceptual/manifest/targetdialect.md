# <a name="targetdialect-element"></a><span data-ttu-id="5fa84-101">Elemento TargetDialect</span><span class="sxs-lookup"><span data-stu-id="5fa84-101">TargetDialect element</span></span>
