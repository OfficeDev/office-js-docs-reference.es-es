# <a name="desktopformfactor-element"></a><span data-ttu-id="04913-101">Elemento DesktopFormFactor</span><span class="sxs-lookup"><span data-stu-id="04913-101">DesktopFormFactor element</span></span>
