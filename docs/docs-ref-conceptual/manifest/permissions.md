# <a name="permissions-element"></a><span data-ttu-id="1b132-101">Elemento Permissions</span><span class="sxs-lookup"><span data-stu-id="1b132-101">Permissions element</span></span>
