# <a name="webapplicationinfo-element"></a><span data-ttu-id="aed58-101">Elemento WebApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="aed58-101">WebApplicationInfo element</span></span>
