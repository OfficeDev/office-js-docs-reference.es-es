# <a name="highresolutioniconurl-element"></a><span data-ttu-id="a24b7-101">Elemento HighResolutionIconUrl</span><span class="sxs-lookup"><span data-stu-id="a24b7-101">HighResolutionIconUrl element</span></span>
