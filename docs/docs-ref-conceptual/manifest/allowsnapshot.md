# <a name="allowsnapshot-element"></a><span data-ttu-id="49340-101">Elemento AllowSnapshot</span><span class="sxs-lookup"><span data-stu-id="49340-101">AllowSnapshot element</span></span>
