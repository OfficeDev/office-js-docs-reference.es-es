# <a name="desktopsettings-element"></a><span data-ttu-id="20cf3-101">Elemento DesktopSettings</span><span class="sxs-lookup"><span data-stu-id="20cf3-101">DesktopSettings element</span></span>
