# <a name="sourcelocation-element"></a><span data-ttu-id="2910f-101">Elemento SourceLocation</span><span class="sxs-lookup"><span data-stu-id="2910f-101">SourceLocation element</span></span>
