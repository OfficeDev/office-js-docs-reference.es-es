# <a name="defaultlocale-element"></a><span data-ttu-id="bbfbc-101">Elemento DefaultLocale</span><span class="sxs-lookup"><span data-stu-id="bbfbc-101">DefaultLocale element</span></span>
