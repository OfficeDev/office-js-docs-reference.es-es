# <a name="functionfile-element"></a><span data-ttu-id="b9937-101">Elemento FunctionFile</span><span class="sxs-lookup"><span data-stu-id="b9937-101">FunctionFile element</span></span>
